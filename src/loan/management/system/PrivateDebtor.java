 ...
 * @author Onyx
 */
public class PrivateDebtor extends Debtor{
    double InterestRate = 0.05;
    public PrivateDebtor(String name, int amount, String date, int term, String number, String address) throws SQLException {
